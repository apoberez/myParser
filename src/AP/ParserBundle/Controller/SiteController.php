...
use AP\ParserBundle\Entity\Site;
use AP\ParserBundle\Form\SiteType;
...
class SiteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('APParserBundle:Site')->findAll();

        return $this->render('APParserBundle:Site:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('APParserBundle:Site:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('APParserBundle:Site')->find($id);
        ...
        return $this->render('APParserBundle:Site:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('APParserBundle:Site:edit.html.twig', array(
            'entity'      => $entity,
